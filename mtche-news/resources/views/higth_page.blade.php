        ...
        <div class="row justify-content-md-center gy-3 gy-xl-4">
          <div class="col-12 col-md-11 col-lg-8 col-xl-7 col-xxl-6 gy-3 gy-xl-4 bsb-entry-content">
            ...
            <div class="fb-share-button" data-href={{route('higthArticle',['id' => $highlight->id])}} data-layout="button" data-size="large">
             <a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=.{{route('higthArticle',['id' => $highlight->id])}}.&src=sdkpreparse" class="fb-xfbml-parse-ignore">Share</a>
            </div>
          </div>
        </div>
      </div>
