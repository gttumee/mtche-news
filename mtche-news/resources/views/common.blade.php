            ...
            <ul class="entry-meta list-unstyled d-flex mb-3">
              <li>
                <a class="d-inline-flex px-2 py-1 link-accent text-accent-emphasis bg-accent-subtle border border-accent-subtle rounded-2 text-decoration-none fs-7"
                  href="#!">Визий зөвөлгөө</a>
              </li>
            </ul>
            <h2 class="display-3 fw-bold mb-4">Япон улсын визний зөвөлгөө</h2>
          </div>
        ...
        <div class="col-12 col-lg-4">
          <a class="d-block bsb-hover-image overflow-hidden rounded" href="#!">
            <img class="img-fluid bsb-scale bsb-hover-scale-up" loading="lazy"
              src="./assets/img/single/single-img-1.jpg" alt="">
          </a>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row justify-content-md-center gy-3 gy-xl-4">
          <div class="col-12 col-md-11 col-lg-8 col-xl-7 col-xxl-6 gy-3 gy-xl-4 bsb-entry-content">
            <p class="lead fw-bold">Everybody needs emotional support, but it can be challenging to know how and when to
              provide it. To create a healthy relationship, you want your partner to know you're there for them, while
              still being mindful of your own mental well-being.</p>
            <p>There are a number of strategies to provide <a href="#!">emotional support</a> in a way that is healthy
          ...
          <div class="col-12 col-md-11 col-lg-8 col-xl-7 col-xxl-6 gy-3 gy-xl-4 bsb-entry-content">
            ...
            <p>When your partner opens up to you, it’s important to really listen and pay attention. It can be easy to
              get distracted, especially when we lead such busy lives, but it’s important your partner is given your
              full attention.</p>
            <figure class="text-accent-emphasis bg-accent-subtle border-start border-5 border-accent rounded-2 p-3">
              <blockquote class="blockquote mb-3">
                <p class="m-0">"You must never dismiss or invalidate what they’re saying or how they’re feeling, as
                  ultimately everyone experiences different emotions in various ways, and there’s no right or wrong way
                  to deal with it"</p>
              </blockquote>
            ...
            <p>If you are not fully present while listening, you may miss important information, which may leave your
              partner feeling like you aren't interested in or don't care about their thoughts and feelings. Active
              listening is a supportive and caring practice when someone is opening up to you.</p>
            ...
            <p>Whether or not physical affection is desired or helpful depends on the person and situation. For some,
              physical affection may feel welcome and comforting when it comes to providing your partner with emotional
              support. This might be something as simple as holding their hand while they’re talking to you, or cuddling
              them when they are struggling. You can offer physical affection by asking questions such as "Can I hold
              your hand or rub your back as you are speaking?" and "Is it okay if I give you a hug?"</p>
            <p>Different people like different levels of physical affection at different times. If you are feeling
              unsure, communicate with your partner so you can learn what they are open to receiving and can provide it
              accordingly.</p>
          </div>
        </div>
      </div>
                ...
                <div class="col-12 col-md-2">
                  <a href="#!" class="bsb-hover-image d-block overflow-hidden rounded">
                    <img class="img-fluid author-avatar bsb-scale bsb-hover-scale-up" loading="lazy"
                      src="./assets/img/single/post-pagination-img-1.jpg" alt="">
                  </a>
                </div>
              </div>
            </div>
            <div class="bg-white p-4 p-md-5 border border-light-subtle">
              <div class="row gy-3 align-items-md-center">
                <div class="col-12 col-md-2">
                  <a href="#!" class="bsb-hover-image d-block overflow-hidden rounded">
                    <img class="img-fluid author-avatar bsb-scale bsb-hover-scale-up" loading="lazy"
                      src="./assets/img/single/post-pagination-img-2.jpg" alt="">
                  </a>
                </div>
              ...
              <div class="row gy-3 align-items-center">
                ...
                <div class="col-md-8">
                  <div class="card-body">
                    ...
                    <p class="card-text mb-3">I am skilled in all aspects of web design, from planning and development
                      to design and testing. I also have experience in web development technologies.</p>
            ...
            <article>
              <div class="card border-0 bg-transparent">
                <figure class="card-img-top mb-4 overflow-hidden bsb-overlay-hover">
                  <a href="#!">
                    <img class="img-fluid bsb-scale bsb-hover-scale-up" loading="lazy"
                      src="./assets/img/blog/blog-img-4.jpg" alt="">
                  </a>
                  <figcaption>
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor"
            ...
            <article>
              <div class="card border-0 bg-transparent">
                <figure class="card-img-top mb-4 overflow-hidden bsb-overlay-hover">
                  <a href="#!">
                    <img class="img-fluid bsb-scale bsb-hover-scale-up" loading="lazy"
                      src="./assets/img/blog/blog-img-5.jpg" alt="">
                  </a>
                  <figcaption>
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor"
                      class="bi bi-eye text-white bsb-hover-fadeInLeft" viewBox="0 0 16 16">
            ...
            <article>
              <div class="card border-0 bg-transparent">
                <figure class="card-img-top mb-4 overflow-hidden bsb-overlay-hover">
                  <a href="#!">
                    <img class="img-fluid bsb-scale bsb-hover-scale-up" loading="lazy"
                      src="./assets/img/blog/blog-img-6.jpg" alt="">
                  </a>
                  <figcaption>
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor"
                      class="bi bi-eye text-white bsb-hover-fadeInLeft" viewBox="0 0 16 16">
                ...
                <div class="card-body m-0 p-0">
                  <div class="entry-header mb-3">
                    ...
                    <h2 class="card-title entry-title h4 m-0">
                      <a class="link-dark text-decoration-none" href="#!">15 Best Remedies To Lose Weight Naturally In
                        Two Weeks</a>
                    </h2>
                  </div>
                </div>
